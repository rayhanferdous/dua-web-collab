        ...
        <div onClick={props.onClick} className="cursor-pointer">
          <div
            ...
            <div className="p-2 flex flex-row items-center">
              ...
              <p
                className={`${
                  props.active ? " font-medium 2xl:text-sm" : "text-mute-grey-200 "
                } font-inter text-start text-base leading-5 lg:text-sm xs:text-sm 2xl:text-sm`}>
                {props.text}
              </p>
            </div>
          </div>
