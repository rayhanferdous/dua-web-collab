  ...
  return (
    <div className="bg-red-100px-8 py-6 mb-2 mt-3  dark:bg-[#223449] z-10">
      ...
      <div className="flex items-start">
        <div className="text-left">
          <p className="font-inter font-normal text-base text-title leading-6 text-justify mb-2.5 dark:text-[#fff9]">
            ...
            different ideas for different projects that will by the will of Allah(Suhanahu Wa Ta'ala) benifit the Ummah. So dear brothers and sisters,
      ...
      <div className="flex justify-end">
        <button onClick={onClick} className=" hover:bg-[#1fa45bee]  text-black font-poppins font-medium text-base  px-6 py-2.5 mt-3.5">
          Close
        </button>
      </div>
    </div>
